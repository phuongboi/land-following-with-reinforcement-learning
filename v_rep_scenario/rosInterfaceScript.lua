...
function resetRobot_cb(msg)
    ...
    if msg.data then -- Outer Lane
        ...
        sim.setObjectPosition(robotHandle,-1,{3.0,0.25,0.13879})
        sim.setObjectOrientation(robotHandle,-1,{0.0,0.0,0.0})
        ...
        sim.setObjectPosition(robotHandle,-1,{9.25,7.0,0.13879})
        sim.setObjectOrientation(robotHandle,-1,{0.0,0.0,3*math.pi/2})
        sim.setThreadAutomaticSwitch(true)
    end
end
